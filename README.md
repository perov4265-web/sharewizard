...
```
┌─────────────────────────────────────────────────────────────────────┐
│  📂 ShareWizard — Сетевой доступ к папке          ✔ Администратор  │
├──────────────────────────────────┬──────────────────────────────────┤
│  📁 Папка и SMB-ресурс           │  🖥 Диагностика                  │
│  ┌─────────────────────┐ [Обзор] │  ● Права администратора   Есть  │
│  │ C:\SharedData\Docs  │         │  ● LanmanServer           Запущ │
│  └─────────────────────┘         │  ● Брандмауэр SMB         Открыт│
│  Имя ресурса: [Docs        ]     │  ● Сетевое обнаружение    Вкл   │
│                                  │  ● SMB v2/v3              Вкл   │
│  👥 Права доступа                │  [🔄 Обновить диагностику]      │
│  Пользователь  SMB   NTFS  [✕]  │ ─────────────────────────────── │
│  Everyone      Change Modify [✕] │  📋 Журнал выполнения           │
│  BUILTIN\Adm.. Full  Full   [✕] │  [08:42:01] Папка создана     ✓ │
│  [+ Добавить]                    │  [08:42:01] LanmanServer      ✓ │
│                                  │  [08:42:02] SMB-ресурс создан ✓ │
│  🔒 Параметры SMB                │  [08:42:02] Порт 445 открыт   ✓ │
│  ☑ Access Based Enumeration     │  [08:42:03] \\PC\Docs          ✓ │
│  ☐ SMB-шифрование               │                                  │
│  🔥 Брандмауэр                   │  [Очистить]   [Сохранить лог]   │
│  ☑ Порт 445   ☑ NetBIOS         │                                  │
│  🌐 Сеть и обнаружение           │                                  │
│  ☑ Сетевое обнаружение          │                                  │
│  ☐ Защита паролем               │                                  │
├──────────────────────────────────┴──────────────────────────────────┤
│  [████████████░░░░]  Выполняется...        [Выход] [▶ ПРИМЕНИТЬ]   │
└─────────────────────────────────────────────────────────────────────┘
```
